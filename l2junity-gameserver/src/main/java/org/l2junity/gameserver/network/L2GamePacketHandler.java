...
import org.l2junity.gameserver.network.clientpackets.*;
import org.l2junity.gameserver.network.clientpackets.adenadistribution.RequestDivideAdena;
import org.l2junity.gameserver.network.clientpackets.adenadistribution.RequestDivideAdenaCancel;
import org.l2junity.gameserver.network.clientpackets.adenadistribution.RequestDivideAdenaStart;
import org.l2junity.gameserver.network.clientpackets.appearance.RequestExCancelShape_Shifting_Item;
import org.l2junity.gameserver.network.clientpackets.appearance.RequestExTryToPutShapeShiftingEnchantSupportItem;
import org.l2junity.gameserver.network.clientpackets.appearance.RequestExTryToPutShapeShiftingTargetItem;
import org.l2junity.gameserver.network.clientpackets.appearance.RequestShapeShiftingItem;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionBuyInfo;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionBuyItem;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionCancel;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionDelete;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionInfo;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionList;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionRegister;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionRegisteredItem;
import org.l2junity.gameserver.network.clientpackets.commission.RequestCommissionRegistrableItemList;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantClose;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantPushOne;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantPushTwo;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantRemoveOne;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantRemoveTwo;
import org.l2junity.gameserver.network.clientpackets.compound.RequestNewEnchantTry;
import org.l2junity.gameserver.network.clientpackets.crystalization.RequestCrystallizeEstimate;
import org.l2junity.gameserver.network.clientpackets.crystalization.RequestCrystallizeItemCancel;
import org.l2junity.gameserver.network.clientpackets.friend.RequestAnswerFriendInvite;
import org.l2junity.gameserver.network.clientpackets.friend.RequestFriendDel;
import org.l2junity.gameserver.network.clientpackets.friend.RequestFriendDetailInfo;
import org.l2junity.gameserver.network.clientpackets.friend.RequestFriendList;
import org.l2junity.gameserver.network.clientpackets.friend.RequestSendFriendMsg;
import org.l2junity.gameserver.network.clientpackets.mentoring.ConfirmMenteeAdd;
import org.l2junity.gameserver.network.clientpackets.mentoring.RequestMenteeAdd;
import org.l2junity.gameserver.network.clientpackets.mentoring.RequestMenteeWaitingList;
import org.l2junity.gameserver.network.clientpackets.mentoring.RequestMentorCancel;
import org.l2junity.gameserver.network.clientpackets.mentoring.RequestMentorList;
import org.l2junity.gameserver.network.clientpackets.primeshop.RequestBRBuyProduct;
import org.l2junity.gameserver.network.clientpackets.primeshop.RequestBRGamePoint;
...
import org.l2junity.gameserver.network.clientpackets.shuttle.RequestShuttleGetOn;
