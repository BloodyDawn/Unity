...
public enum OutgoingPackets
{
	...
	RECIVE_VIP_PRODUCT_LIST(0xFE, 0x17E),
	RECIVE_VIP_LUCKY_GAME_INFO(0xFE, 0x17F),
	RECIVE_VIP_LUCKY_GAME_ITEM_LIST(0xFE, 0x180),
	RECIVE_VIP_LUCKY_GAME_RESULT(0xFE, 0x181),
	RECIVE_VIP_INFO(0xFE, 0x182),
	RECIVE_VIP_INFO_REMAIN_TIME(0xFE, 0x183),
	RECEIVE_VIP_BOT_CAPTCHA_IMAGE(0xFE, 0x184),
	RECEIVE_VIP_BOT_CAPTCHA_ANSWER_RESULT(0xFE, 0x185),
	
	EX_PLEDGE_BONUS_OPEN(0xFE, 0x18D),
	EX_PLEDGE_BONUS_LIST(0xFE, 0x18E),
	EX_PLEDGE_BONUS_RESET(0xFE, 0x18F),
