...
import org.l2junity.gameserver.model.NpcWalkerNode;
import org.l2junity.gameserver.model.WalkInfo;
import org.l2junity.gameserver.model.WalkRoute;
import org.l2junity.gameserver.model.actor.Npc;
import org.l2junity.gameserver.model.actor.instance.L2MonsterInstance;
import org.l2junity.gameserver.model.actor.tasks.npc.walker.ArrivedTask;
					...
					if (r.getNodeName().equals("point"))
					{
						...
						else
						{
							...
							if (node != null)
							{
								...
								if (npcString == null)
								{
									LOGGER.warn("Unknown npcString '{}' for route '{}'", node.getNodeValue(), routeName);
									continue;
								}
							}
							else
