...
public class TopicBBSManager extends BaseBBSManager
{
	...
	private void showNewTopic(Forum forum, PlayerInstance activeChar, int idf)
	{
		if (forum == null)
		{
	...
	private void showMemoNewTopics(Forum forum, PlayerInstance activeChar)
	{
	...
	private void showTopics(Forum forum, PlayerInstance activeChar, int index, int idf)
	{
		if (forum == null)
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>the forum: " + idf + " is not implemented yet</center><br><br></body></html>", activeChar);
	...
	private void showMemoTopics(Forum forum, PlayerInstance activeChar, int index)
	{
		forum.vload();
