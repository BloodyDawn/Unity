...
/**
 * Pet actions player action handler.
 * @author Nik
 */
public final class PetAction implements IPlayerActionHandler
{
	@Override
	...
	{
		PlayerActionHandler.getInstance().registerHandler(new PetAction());
	}
}
