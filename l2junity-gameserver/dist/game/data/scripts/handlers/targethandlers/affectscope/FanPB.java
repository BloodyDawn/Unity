...
/**
 * Fan affect scope implementation. Gathers objects in a certain angle of circular area around yourself.
 * @author Nik
 */
public class FanPB implements IAffectScopeHandler
{
	...
	public List<? extends WorldObject> getAffectedScope(Creature activeChar, Creature target, Skill skill)
	{
		...
		List<Creature> result = World.getInstance().getVisibleObjects(activeChar, Creature.class, fanRadius, filter);
