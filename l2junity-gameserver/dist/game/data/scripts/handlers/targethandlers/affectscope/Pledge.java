...
public class Pledge implements IAffectScopeHandler
{
	...
	public List<? extends WorldObject> getAffectedScope(Creature activeChar, Creature target, Skill skill)
	{
		...
		if (player != null)
		{
			...
			final Predicate<PlayerInstance> filter = p -> !p.isDead() && (((clan != null) && (clan == p.getClan())) || ((clan == null) && (p == player))) && (affectObject != null ? affectObject.checkAffectedObject(activeChar, p) : true);
