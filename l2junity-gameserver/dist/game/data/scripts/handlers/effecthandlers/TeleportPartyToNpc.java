 ...
 * @author Nik
 */
public final class TeleportPartyToNpc extends AbstractEffect
{
	private final int _npcId;
	
	public TeleportPartyToNpc(Condition attachCond, Condition applyCond, StatsSet set, StatsSet params)
	{
	...
	public void instant(Creature effector, Creature effected, Skill skill)
	{
		...
		if (teleLocation != null)
		{
			...
			{
				effected.getParty().forEachMember(p ->
				{
					teleport(p, teleLocation);
					return true;
				});
			}
			else
