...
public final class MagicalAttackRange extends AbstractEffect
{
	...
	public void onStart(BuffInfo info)
	{
		...
		final double power = _power + CommonUtil.map(activeChar.calculateDistance(target, false, false), 0, info.getSkill().getCastRange(), _powerRange, 0);
		...
		int damage = (int) Formulas.calcMagicDam(activeChar, target, info.getSkill(), power, shld, sps, bss, mcrit);
