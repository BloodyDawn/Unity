...
public final class BabyPets extends AbstractNpcAI
{
	...
	private BabyPets()
	{
		super(BabyPets.class.getSimpleName(), "ai/group_template");
	...
	private void castHeal(Summon summon, SkillHolder skill, int maxHpPer)
	{
		...
		if (!owner.isDead() && (((owner.getCurrentHp() / owner.getMaxHp()) * 100) < maxHpPer) && !summon.isHungry() && !summon.isCastingNow(SkillCaster::isNormalType) && SkillCaster.checkDoCastConditions(summon, skill.getSkill()))
		{
