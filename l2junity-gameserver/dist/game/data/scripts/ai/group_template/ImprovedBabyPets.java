...
public final class ImprovedBabyPets extends AbstractNpcAI
{
	...
	private boolean castBuff(Summon summon, int stepNumber, int buffNumber)
	{
		...
		if ((skill != null) && (owner != null))
		{
			...
			if ((skillInfo == null) && summon.checkDoCastConditions(skill.getSkill()) && !summon.isCastingNow(SkillCaster::isNormalType) && !owner.isDead())
			{
				if (mergedSkill != null)
				{
	...
	private void castHeal(Summon summon, int stepNumber, int healNumber)
	{
		...
		if ((skill != null) && (owner != null) && summon.checkDoCastConditions(skill.getSkill()) && !summon.isCastingNow(SkillCaster::isNormalType) && !owner.isDead())
		{
