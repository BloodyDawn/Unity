 ...
 */
package ai.individual.GuillotineFortress;
	...
	public String onSpawn(Npc npc)
	{
		switch (npc.getId())
		{
			case EXECUTED_MAIDEN_VENGEFUL_SPIRIT:
				startQuestTimer("SPAM_TEXT1", 20000, npc, null, true);
				break;
			case SPIRIT_OF_THE_TORTURED_DWARF:
				startQuestTimer("SPAM_TEXT2", 20000, npc, null, true);
				break;
			case SPIRIT_OF_ONE_BURNED_ALIVE:
				startQuestTimer("SPAM_TEXT3", 20000, npc, null, true);
				break;
		}
