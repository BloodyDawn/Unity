 ...
 * @author malyelfik
 */
public final class Q10769_LettersFromTheQueenCrumaTowerPart1 extends Quest
{
	// NPCs
	...
	{
		super(10769, Q10769_LettersFromTheQueenCrumaTowerPart1.class.getSimpleName(), "Letters from the Queen: Cruma Tower, Part 1");
	...
	public void onPlayerPressTutorialMark(OnPlayerPressTutorialMark event)
	{
		if (event.getMarkId() == getId())
		{
			...
			st.startQuest();
			player.sendPacket(new PlaySound(3, "Npcdialog1.serenia_quest_3", 0, 0, 0, 0, 0));
	...
	public void OnPlayerBypass(OnPlayerBypass event)
	{
		...
		if (command.equals("Q10769_teleport") && (st != null) && st.isCond(1) && hasQuestItems(player, SOE_DION_TOWN))
		{
	...
	{
		new Q10769_LettersFromTheQueenCrumaTowerPart1();
	}
}
